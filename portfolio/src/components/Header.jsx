    ...
    return(
        <header className='bg-auto bg-no-repeat md:bg-contain'>
            <nav className='mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global'>
                <div className="flex lg:flex-1 uppercase">
                    <Link to='/' >Logo</Link>
                </div>
                <div className='flex lg:hidden'>
                    <button type='button' className='-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700' onClick={() => setIsMobileMenuOpen(true)}>
                        <span className='sr-only'>Open main menu</span>
                        <Bars3Icon className='h-8 w-6' aria-hidden='true'></Bars3Icon>
                    </button>
                </div>
                ...
                <div className='fixed inset-0 z-10'>
                    <Dialog.Panel className='fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10'>
                        <div className='flex items-center justify-between'>
                            <div className="flex lg:flex-0 uppercase">
                               <Link to='/' >Logo</Link>
                            </div>
                        ...
                        <div className='mt-3 pt-0.50 flow-root'>
                            <div className='-my-6 divide-y divide-gray-500/10'>
                                <div className='space-y-2 py-6'>
                                    <ul className='flex flex-col p-4 md:p-0 mt-4 mr-56 font-medium  md:flex-row md:space-x-8 md:mt-0 md:border-0 uppercase'>
                                        <li>
